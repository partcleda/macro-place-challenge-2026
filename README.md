...
> **Swag** column: ✅ = swag-eligible (submission demonstrates minimum functionality — runs end-to-end and produces a 0-overlap valid placement; full-verified teams qualify automatically). ❌ = checked, did not meet the bar. See [`swag_verify/REPORT.md`](swag_verify/REPORT.md) for per-team reasons and caveats.

| Rank | Team | Avg Proxy Cost | Best | Worst | Overlaps | Runtime | Verified | Swag | Notes |
|------|------|---------------|------|-------|----------|---------|----------|------|-------|
