...
Pair-push notes: a minimal-displacement legalization candidate is gated to small IBM buckets (`240 <= n_hard <= 320`, `0.30 <= utilization < 0.52`), large high-utilization/skewed buckets, one very-low-utilization bucket, and one `ibm16`-like medium bucket. The small low-skew `ibm09`-like bucket uses a wider gap; the other pair-push gates use a fast `0.001` gap. The candidate is appended only when hard-legal, then still competes through the official proxy scorer. Integrated validation improved `ibm01` to `1.0054`, `ibm03` to `1.2812`, `ibm04` to `1.2760`, `ibm07` to `1.4322`, `ibm08` to `1.4515`, `ibm09` to `1.0778`, `ibm10` to `1.3255`, `ibm12` to `1.6137`, `ibm16` to `1.4808`, and `ibm18` to `1.7658`.
