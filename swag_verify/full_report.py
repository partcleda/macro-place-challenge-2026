...
OVERRIDES = {
    ...
    "K2HAL":            ("✅ ELIGIBLE",   "RECOVERED — harness artifact (uninitialized benchmark submodule made resolve_plc() return None); re-run self-contained w/ submodule populated -> ibm01 VALID (0.8124). Not a code bug."),
